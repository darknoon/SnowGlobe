...
#define SHKFacebookKey				@"72da392b16ff9ff284b1ec853e0ffc32"
#define SHKFacebookSecret			@"69b3ed4c0c88326ca4dcbcead878862d"
 ...
 */
#define SHKTwitterConsumerKey		@"AB5TCArQQMbtyoCgLrdetw"
#define SHKTwitterSecret			@"dn7EYh4dNCBFZPzMqJhMm0uMUhQ3zUcXlf7eD2xTc"
#define SHKTwitterCallbackUrl		@"http://darknoon.com/snow/auth-callback" // You need to set this if using OAuth, see note above (xAuth users can skip it)
...
typedef enum {
	SHKImageCompressionTypeJPEG,
	SHKImageCompressionTypePNG,
} SHKImageCompressionType;

#define SHKTwitterImageCompressionType SHKImageCompressionTypePNG
